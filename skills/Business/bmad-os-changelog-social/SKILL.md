...
requires: []
examples:
  - "Generate a Discord + LinkedIn release announcement from the latest CHANGELOG entry."
  - "Write a Twitter/X post announcing this release, highlighting user-facing features and fixes."
---
