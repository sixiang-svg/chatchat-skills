...
id: prose
name: Prose
description: Practical guidance for prose workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Prose workflow."
  - "What are best practices and trade-offs for Prose?"
---
# Prose

Help the agent provide practical guidance for prose workflows.

## When to Use

- The user needs help implementing or improving prose workflows.
