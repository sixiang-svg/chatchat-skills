...
id: seaborn
name: Seaborn
description: Practical guidance for seaborn workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Seaborn workflow."
  - "What are best practices and trade-offs for Seaborn?"
---
# Seaborn

Help the agent provide practical guidance for seaborn workflows.

## When to Use

- The user needs help implementing or improving seaborn workflows.
