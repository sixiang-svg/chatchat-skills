...
id: openai-whisper
name: OpenAI Whisper
description: Practical guidance for openai whisper workflows.
category: Data & AI
requires: [".mp3", ".wav", ".m4a", ".mp4", ".webm"]
examples:
  - "Help me design a practical OpenAI Whisper workflow."
  - "What are best practices and trade-offs for OpenAI Whisper?"
---
# OpenAI Whisper

Help the agent provide practical guidance for openai whisper workflows.

## When to Use

- The user needs help implementing or improving openai whisper workflows.
