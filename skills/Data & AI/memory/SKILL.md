...
id: memory
name: Memory
description: Practical guidance for memory workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Memory workflow."
  - "What are best practices and trade-offs for Memory?"
---
# Memory

Help the agent provide practical guidance for memory workflows.

## When to Use

- The user needs help implementing or improving memory workflows.
