...
id: statsmodels
name: Statsmodels
description: Practical guidance for statsmodels workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Statsmodels workflow."
  - "What are best practices and trade-offs for Statsmodels?"
---
# Statsmodels

Help the agent provide practical guidance for statsmodels workflows.

## When to Use

- The user needs help implementing or improving statsmodels workflows.
