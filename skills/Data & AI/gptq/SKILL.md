...
id: gptq
name: GPTQ
description: Practical guidance for gptq workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical GPTQ workflow."
  - "What are best practices and trade-offs for GPTQ?"
---
# GPTQ

Help the agent provide practical guidance for gptq workflows.

## When to Use

- The user needs help implementing or improving gptq workflows.
