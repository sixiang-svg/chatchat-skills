...
id: transformers
name: Transformers
description: Practical guidance for transformers workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Transformers workflow."
  - "What are best practices and trade-offs for Transformers?"
---
# Transformers

Help the agent provide practical guidance for transformers workflows.

## When to Use

- The user needs help implementing or improving transformers workflows.
