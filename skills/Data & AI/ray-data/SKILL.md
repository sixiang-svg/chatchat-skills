...
id: ray-data
name: Ray Data
description: Practical guidance for ray data workflows.
category: Data & AI
requires: []
examples:
  - "Help me design a practical Ray Data workflow."
  - "What are best practices and trade-offs for Ray Data?"
---
# Ray Data

Help the agent provide practical guidance for ray data workflows.

## When to Use

- The user needs help implementing or improving ray data workflows.
