...
description: Concrete workflow for tailwindcss development with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current tailwindcss development goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement tailwindcss development for this repository, including key decisions and checkpoints.
  - Create a concise tailwindcss development workflow with concrete steps, risks, and final deliverables for my project.
---

# Tailwindcss Development

Provide practical guidance to plan and execute tailwindcss development tasks in real projects.

## When to Use

- You need to scope and deliver tailwindcss development work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the tailwindcss development effort.
