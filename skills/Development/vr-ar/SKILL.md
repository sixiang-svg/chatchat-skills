...
id: vr-ar
name: Vr Ar
description: Concrete workflow for vr ar with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current vr ar goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement vr ar for this repository, including key decisions and checkpoints.
  - Create a concise vr ar workflow with concrete steps, risks, and final deliverables for my project.
---

# Vr Ar

Provide practical guidance to plan and execute vr ar tasks in real projects.

## When to Use

- You need to scope and deliver vr ar work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the vr ar effort.
