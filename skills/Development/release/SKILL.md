...
id: release
name: Release
description: Concrete workflow for release with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current release goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement release for this repository, including key decisions and checkpoints.
  - Create a concise release workflow with concrete steps, risks, and final deliverables for my project.
---

# Release

Provide practical guidance to plan and execute release tasks in real projects.

## When to Use

- You need to scope and deliver release work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the release effort.
