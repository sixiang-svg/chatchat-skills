...
description: Concrete workflow for saga orchestration with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current saga orchestration goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement saga orchestration for this repository, including key decisions and checkpoints.
  - Create a concise saga orchestration workflow with concrete steps, risks, and final deliverables for my project.
---

# Saga Orchestration

Provide practical guidance to plan and execute saga orchestration tasks in real projects.

## When to Use

- You need to scope and deliver saga orchestration work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the saga orchestration effort.
