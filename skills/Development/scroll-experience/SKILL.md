...
description: Concrete workflow for scroll experience with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current scroll experience goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement scroll experience for this repository, including key decisions and checkpoints.
  - Create a concise scroll experience workflow with concrete steps, risks, and final deliverables for my project.
---

# Scroll Experience

Provide practical guidance to plan and execute scroll experience tasks in real projects.

## When to Use

- You need to scope and deliver scroll experience work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the scroll experience effort.
