...
description: Concrete workflow for nodejs backend patterns with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current nodejs backend patterns goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement nodejs backend patterns for this repository, including key decisions and checkpoints.
  - Create a concise nodejs backend patterns workflow with concrete steps, risks, and final deliverables for my project.
---

# Nodejs Backend Patterns

Provide practical guidance to plan and execute nodejs backend patterns tasks in real projects.

## When to Use

- You need to scope and deliver nodejs backend patterns work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the nodejs backend patterns effort.
