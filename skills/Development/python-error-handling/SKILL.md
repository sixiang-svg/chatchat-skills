...
description: Concrete workflow for python error handling with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current python error handling goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement python error handling for this repository, including key decisions and checkpoints.
  - Create a concise python error handling workflow with concrete steps, risks, and final deliverables for my project.
---

# Python Error Handling

Provide practical guidance to plan and execute python error handling tasks in real projects.

## When to Use

- You need to scope and deliver python error handling work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the python error handling effort.
