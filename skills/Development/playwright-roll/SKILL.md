...
description: Concrete workflow for playwright roll with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current playwright roll goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement playwright roll for this repository, including key decisions and checkpoints.
  - Create a concise playwright roll workflow with concrete steps, risks, and final deliverables for my project.
---

# Playwright Roll

Provide practical guidance to plan and execute playwright roll tasks in real projects.

## When to Use

- You need to scope and deliver playwright roll work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the playwright roll effort.
