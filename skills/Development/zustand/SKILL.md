...
id: zustand
name: Zustand
description: Concrete workflow for zustand with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current zustand goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement zustand for this repository, including key decisions and checkpoints.
  - Create a concise zustand workflow with concrete steps, risks, and final deliverables for my project.
---

# Zustand

Provide practical guidance to plan and execute zustand tasks in real projects.

## When to Use

- You need to scope and deliver zustand work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the zustand effort.
