...
description: Concrete workflow for tailwind design system with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current tailwind design system goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement tailwind design system for this repository, including key decisions and checkpoints.
  - Create a concise tailwind design system workflow with concrete steps, risks, and final deliverables for my project.
---

# Tailwind Design System

Provide practical guidance to plan and execute tailwind design system tasks in real projects.

## When to Use

- You need to scope and deliver tailwind design system work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the tailwind design system effort.
