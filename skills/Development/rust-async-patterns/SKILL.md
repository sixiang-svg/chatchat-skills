...
description: Concrete workflow for rust async patterns with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current rust async patterns goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement rust async patterns for this repository, including key decisions and checkpoints.
  - Create a concise rust async patterns workflow with concrete steps, risks, and final deliverables for my project.
---

# Rust Async Patterns

Provide practical guidance to plan and execute rust async patterns tasks in real projects.

## When to Use

- You need to scope and deliver rust async patterns work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the rust async patterns effort.
