...
id: sessions
name: Sessions
description: Concrete workflow for sessions with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current sessions goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement sessions for this repository, including key decisions and checkpoints.
  - Create a concise sessions workflow with concrete steps, risks, and final deliverables for my project.
---

# Sessions

Provide practical guidance to plan and execute sessions tasks in real projects.

## When to Use

- You need to scope and deliver sessions work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the sessions effort.
