...
description: Concrete workflow for reasoningbank intelligence with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current reasoningbank intelligence goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement reasoningbank intelligence for this repository, including key decisions and checkpoints.
  - Create a concise reasoningbank intelligence workflow with concrete steps, risks, and final deliverables for my project.
---

# Reasoningbank Intelligence

Provide practical guidance to plan and execute reasoningbank intelligence tasks in real projects.

## When to Use

- You need to scope and deliver reasoningbank intelligence work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the reasoningbank intelligence effort.
