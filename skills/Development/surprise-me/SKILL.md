...
id: surprise-me
name: Surprise Me
description: Concrete workflow for surprise me with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current surprise me goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement surprise me for this repository, including key decisions and checkpoints.
  - Create a concise surprise me workflow with concrete steps, risks, and final deliverables for my project.
---

# Surprise Me

Provide practical guidance to plan and execute surprise me tasks in real projects.

## When to Use

- You need to scope and deliver surprise me work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the surprise me effort.
