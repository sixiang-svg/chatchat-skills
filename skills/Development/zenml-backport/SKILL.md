...
id: zenml-backport
name: Zenml Backport
description: Concrete workflow for zenml backport with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current zenml backport goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement zenml backport for this repository, including key decisions and checkpoints.
  - Create a concise zenml backport workflow with concrete steps, risks, and final deliverables for my project.
---

# Zenml Backport

Provide practical guidance to plan and execute zenml backport tasks in real projects.

## When to Use

- You need to scope and deliver zenml backport work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the zenml backport effort.
