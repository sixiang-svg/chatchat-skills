...
id: start
name: Start
description: Concrete workflow for start with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current start goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement start for this repository, including key decisions and checkpoints.
  - Create a concise start workflow with concrete steps, risks, and final deliverables for my project.
---

# Start

Provide practical guidance to plan and execute start tasks in real projects.

## When to Use

- You need to scope and deliver start work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the start effort.
