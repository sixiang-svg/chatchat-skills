...
id: modern-tools
name: Modern Tools
description: Concrete workflow for modern tools with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current modern tools goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement modern tools for this repository, including key decisions and checkpoints.
  - Create a concise modern tools workflow with concrete steps, risks, and final deliverables for my project.
---

# Modern Tools

Provide practical guidance to plan and execute modern tools tasks in real projects.

## When to Use

- You need to scope and deliver modern tools work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the modern tools effort.
