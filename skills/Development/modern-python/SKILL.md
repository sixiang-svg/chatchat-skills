...
id: modern-python
name: Modern Python
description: Concrete workflow for modern python with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current modern python goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement modern python for this repository, including key decisions and checkpoints.
  - Create a concise modern python workflow with concrete steps, risks, and final deliverables for my project.
---

# Modern Python

Provide practical guidance to plan and execute modern python tasks in real projects.

## When to Use

- You need to scope and deliver modern python work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the modern python effort.
