...
id: pennyLane
name: Pennylane
description: Concrete workflow for pennylane with specific inputs, execution steps, and deliverables.
category: Development
requires:
  - current pennylane goal and expected outcome
  - relevant codebase or project context (paths, stack, constraints)
  - acceptance criteria, timeline, and known risks
examples:
  - Help me plan and implement pennylane for this repository, including key decisions and checkpoints.
  - Create a concise pennylane workflow with concrete steps, risks, and final deliverables for my project.
---

# Pennylane

Provide practical guidance to plan and execute pennylane tasks in real projects.

## When to Use

- You need to scope and deliver pennylane work with clear decisions.
- You want a repeatable approach that reduces rework and missed requirements.

## Workflow

1. Clarify objectives, constraints, and success criteria for the pennylane effort.
